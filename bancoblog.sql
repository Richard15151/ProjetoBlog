...
(1, 'O jogo de ontem foi eletrizante!'),
(1, 'Não posso esperar por Memphis no ataque'),
(2, 'Primeiro gol do André Ramalho pelo Corinthians!'),
(3, 'Garro como sempre comandando o meio campo');
